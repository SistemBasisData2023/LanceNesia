...
const About = () => {
  const Wrapper = styled.section`
    ...
    .about-card {
      background-color: var(--shady-blue-color);
      position: relative;
      text-align: center;
      overflow: hidden;
      border-radius: 5px;
      box-shadow: 2.9px 3.4px 3.6px rgba(0, 0, 0, 0.045), 7.9px 9.3px 10px rgba(0, 0, 0, 0.065), 19px 22.3px 24.1px rgba(0, 0, 0, 0.085), 63px 74px 80px rgba(0, 0, 0, 0.13);
      margin: 0px 25px;
      padding: 45px 70px;
    }
          ...
          <div className="container">
            <div data-aos="fade-right" data-aos-offset="300" data-aos-easing="ease-in-out" className="about-card">
              ...
              <ul className="social">
                ...
                <li>
                  <a href="https://www.instagram.com/abdfikih/" className="fab fa-instagram">
                    <span></span>
                  </a>
                </li>
                <li>
