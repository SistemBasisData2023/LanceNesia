...
const UserMenu = (props) => {
  ...
  return (
    <>
      ...
      <StyledMenu id="notificationsMenu" anchorEl={props.anchorEl} keepMounted open={Boolean(props.anchorEl)} onClose={props.onClose}>
        {/* Header */}
        <BoxStyle>
        ...
        {/* Footer */}
        <BoxStyle>
          <LinkStyle href="#" underline="none" onClick={handleLogout}>
            Logout
          </LinkStyle>
        </BoxStyle>
      </StyledMenu>
